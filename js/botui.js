...
function bot_ui_ini() {
    var botui = new BotUI("hello-Dong_e")
    botui.message.add({
        delay: 800,
        content: "Hi, friends👋"
    }).then(function () {
        botui.message.add({
            delay: 1100,
            content: "这里是 Dong_e 记录学习的博客"
        }).then(function () {
            botui.message.add({
                delay: 1100,
                content: "一个向往美好社会的男孩子"
            }).then(function () {
                botui.action.button({
                    delay: 1600,
                    action: [{
    ...
    var sure = function () {
            ...
            botui.message.add({
                ...
                botui.message.add({
                    ...
                    botui.message.add({
                        ...
                        botui.message.add({
                            delay: 1500,
                            content: "主学HTML/CSS/JavaScript，正在学习java"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
                                content: "专业方向，前端开发"
        ...
        fourthpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "这个名字是由高中一篇文言文，一个游戏截取的 "
            }).then(function () {
                botui.message.add({
                    delay: 1100,
                    content: "还没想到一个更厉害的名字就没改，哈哈哈"
                }).then(function () {
                    botui.action.button({
                        delay: 1500,
                        action: [{
